...
const Footer = () => {
    return(
        <div className='w-full h-screen bg-zinc-900 p-20 flex overflow-hidden'>
            ...
            <div className='w-1/2 mt-15 pr-20' >
                <h1 className='text-[6vw] font-semibold uppercase leading-none '>Presentations
                </h1>
                <div className='dets mt-15'>
                        <a className='block mt-5 text-xl font-light' href="#">Facebook</a>
                        <a className='block mt-5 text-xl font-light' href="#">Instagram</a>
                        <a className='block mt-5 text-xl font-light' href="#">Twitter</a>
                    </div>
            </div>
        </div>
    )
